...
public class PersistableCustomPaymentPopulator extends AbstractDataPopulator<PersistableCustomPayment, Payment> {

	PricingService pricingService;

	@Override
	public Payment populate(PersistableCustomPayment source, Payment target, MerchantStore store, Language language)
