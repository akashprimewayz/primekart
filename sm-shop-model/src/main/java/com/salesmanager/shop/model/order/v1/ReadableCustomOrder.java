...
import com.salesmanager.shop.model.order.transaction.ReadableCustomPayment;

public class ReadableCustomOrder extends Order {
	...
	private ReadableCustomPayment payment;
	...
	public ReadableCustomPayment getPayment() {
		return payment;
	}

	public void setPayment(ReadableCustomPayment payment) {
