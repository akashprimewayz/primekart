...
public class TransactionServiceCustomImpl extends SalesManagerEntityServiceImpl<Long, Transaction> implements TransactionService {
	

	private TransactionRepository transactionRepository;
	
	@Inject
	public TransactionServiceCustomImpl(TransactionRepository transactionRepository) {
